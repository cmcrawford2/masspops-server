...
var ModelDistinct = /*#__PURE__*/function () {
  function ModelDistinct(table) {
    (0, _classCallCheck2["default"])(this, ModelDistinct);
  ...
  (0, _createClass2["default"])(ModelDistinct, [{
    key: "select",
    value: function () {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = "SELECT DISTINCT ".concat(columns, " FROM ").concat(this.table);
