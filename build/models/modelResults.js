...
var ModelResults = /*#__PURE__*/function () {
  function ModelResults(table) {
    (0, _classCallCheck2["default"])(this, ModelResults);
  ...
  (0, _createClass2["default"])(ModelResults, [{
    key: "select",
    value: function () {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = "SELECT \"Poll_ID\", \"Question_ID\", \"Options\", \"Results\" FROM ".concat(this.table, "\n                   WHERE \"Question_ID\" IN ").concat(questionIdString);
